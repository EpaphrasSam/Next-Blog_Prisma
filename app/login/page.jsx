  ...
  return (
    <div className="relative flex justify-center items-center mt-14 ">
      ...
      <div className="p-[100px] max-sm:p-[70px] max-[440px]:p-[40px] bg-LsoftBg dark:bg-DsoftBg flex flex-col items-center justify-center gap-6 rounded-xl">
        ...
        <div className="flex gap-3 p-4 rounded-[10px] border-none text-white font-bold cursor-pointer bg-[#111]">
          <FaGithub className="mt-1" size={18} />
          Sign in With Github
        </div>
        <div className="flex gap-3 p-4 rounded-[10px] border-none text-white font-bold cursor-pointer bg-[#087BEA]">
          <FaFacebook className="mt-1" size={18} />
